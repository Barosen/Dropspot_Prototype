//
//  OptionsInFlowViewController.swift
//  Dropspot
//
//  Created by Kevin Zetterlind on 2022-10-06.
//

import UIKit

class OptionsInFlowViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        buttonOne.setImage(UIImage(named: "arrow.left"), for: .normal)
    ...
    @IBAction func followingButtonPress(_ sender: Any) {
        ...
        FollowingButton.backgroundColor = .systemGray3
    }
    @IBAction func notFollowingButtonPress(_ sender: Any) {
        FollowingButton.backgroundColor = .white
        notFollowingButton.backgroundColor = .systemGray3
    }
